...
const getIdentifierInput = () => screen.getByPlaceholderText(/username or email address/i);
const getPasswordInput = () => screen.getByPlaceholderText(/••••••••/i);
const getSubmitButton = () => screen.getByRole("button", { name: /initialize session/i });
