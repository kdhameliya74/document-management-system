  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Item">
      <div className="flex flex-col gap-6">
        <p className="text-text-main">Are you sure you want to delete <span className="font-bold text-primary">"{item?.name}"</span>? This action cannot be undone.</p>
        <div className="flex justify-end gap-4">
          ...
          <button 
            ...
            className="py-2.5 px-5 rounded-xl font-bold text-sm transition-all bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white cursor-pointer"
          >
            Delete Item
          </button>
        </div>
