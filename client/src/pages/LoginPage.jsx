    ...
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden bg-bg-main">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-medium text-text-main mb-2">Welcome Back</h1>
          <p className="text-text-muted">Enter your details to access your files</p>
        </div>
        {error && (
        ...
        <div className="mt-8 text-center text-text-muted">
          <p>
            ...
            <Link to={ROUTES.SIGNUP} className="text-primary font-normal ml-1 hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
